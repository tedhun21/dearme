...
export default function SocialPost(): JSX.Element {
  ...
  return (
    <div className="mb-20 flex w-full min-w-[360px] max-w-[600px] flex-col bg-default-200  pl-5 pr-5">
      {/* 유저 프로필 & 목표 */}
      ...
      {/* 게시물 body */}
      <div className="pt-2 text-base font-semibold text-default-700">
        Happy Ending
      </div>
      ...
      {/* 좋아요 & 댓글 */}
      <div className="flex items-center">
        <div className="mr-2 flex items-center" onClick={toggleLike}>
          <img
            src={liked ? "/social/fullheart.svg" : "/social/emptyheart.svg"}
            alt="Like"
            className="mr-1 cursor-pointer"
          />
          {/* <div className="text-sm font-semibold text-default-700">3</div> */}
        </div>
        ...
        <div className="flex items-center" onClick={toggleComments}>
          <img
            ...
            className="mr-1 cursor-pointer"
          />
          <div className="text-sm font-semibold text-default-700">2</div>
        </div>
      </div>

      {/* 좋아요 목록 modal*/}
      <div
        className="mt-2 flex cursor-pointer text-sm font-semibold text-default-500"
        onClick={handleOpen}
      >
        3 Likes
      </div>
      ...
      {showComments && (
        <div className="mt-4 ">
          ...
          <div className="mb-2 mt-5 flex items-center">
            ...
            <div className="w-full flex-col pl-3">
              <div className="flex h-8 items-center rounded-full border p-0.5">
                <InputBase
                  sx={{
                    ml: 2,
                    flex: 1,
